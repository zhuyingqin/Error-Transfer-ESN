...
function [config] = getAdditionalParameters1(config)
...
config.leak_on1 = 0;                                 % add leak states
...
config.feedback_connectivity1 = 0.1;

% node functionality logsig
...
if strcmp(config.dataset,'test_pulse')%strcmp 
    config.preprocess = 0;
else
